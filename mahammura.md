...
- ¼ cup Olive Oil
- 1 tbsp Lemon Jiuce
- 2 TBSP Pomegranate Molassus

Start by roasting and peeling the bell peppers via your favorite technique.

[![Roasting Peppers](http://img.youtube.com/vi/tid-cWXO6xQ/0.jpg)](https://youtu.be/tid-cWXO6xQ "Roasting Peppers")
...
- **Tree nuts** — walnuts (core to the dish).
- **Gluten / wheat** — the bread crumbs (and pita, if served with it). Use gluten-free bread crumbs to avoid.
...
Estimated for a yield of about 2 cups (~8 servings) and a serving size of 1/4 cup.
...
### Whole recipe (~2 cups, 8 servings)
